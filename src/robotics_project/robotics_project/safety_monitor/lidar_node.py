...
class SafetyMonitor(Node):
    ...
    def __init__(self):
        ...
        self.warn_distance   = 1.5
        self.check_angle_deg = 45.0
        self.replan_cooldown = 10.0
    ...
    def scan_callback(self, msg: LaserScan):
        ...
        for i, r in enumerate(ranges):
            if math.isnan(r) or math.isinf(r) or r <= max(range_min, 0.1) or r > range_max:
                continue
        ...
        if closest_front <= self.danger_distance:
            ...
            status_msg.data = (
                f'WARNING - obstacle at {closest_warning:.2f}m ahead.'
            )
